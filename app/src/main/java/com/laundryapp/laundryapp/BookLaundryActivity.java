...
import com.laundryapp.laundryapp.util.SharedPrefsUtil;
...
public class BookLaundryActivity extends AppCompatActivity implements View.OnClickListener, RestApiCallUtil.VolleyCallback
{
	...
	public void onCreate(final Bundle savedInstanceState)
	{
		...
		commonHeaderData(BookLaundryActivity.this);
	...
	public void onClick(final View view)
	{
		switch (view.getId())
		{
			case R.id.submitBtn:
				...
				RestApiCallUtil.postServerResponse(mContext, ApiRequestReferralCode.BOOK_LAUNDRY_SUBMIT, params);
				break;
		}
	}
