...
public class TrackOrderActivity extends AppCompatActivity implements View.OnClickListener, RestApiCallUtil.VolleyCallback
{
	...
	public void onCreate(final Bundle savedInstanceState)
	{
		...
		commonHeaderData(TrackOrderActivity.this);
	...
	public void onClick(final View view)
	{
		switch (view.getId())
		{
			case R.id.submitBtn:
				...
				RestApiCallUtil.postServerResponse(mContext, ApiRequestReferralCode.TRACK_ORDER_SUBMIT, params);
				break;
		}
	...
	@Override
	public void onSuccessResponse(final ApiRequestReferralCode referralCode, final String response_info, final JSONArray jsonArray, final JSONObject jobject)
	{
			...
			switch (referralCode)
			{
				case TRACK_ORDER_SUBMIT:
					if (response_info != null)
					{
						...
						{
							String hostel_id = jsonArray.getJSONObject(0).getString(Constants.hostel_id);
